...
public class IronLCBlockEntity extends LockedChestBlockEntity implements GeoBlockEntity {
    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public IronLCBlockEntity(BlockPos pos, BlockState state) {
    ...
    private PlayState predicate(AnimationState<IronLCBlockEntity> animatedBlockEntityAnimationState) {
