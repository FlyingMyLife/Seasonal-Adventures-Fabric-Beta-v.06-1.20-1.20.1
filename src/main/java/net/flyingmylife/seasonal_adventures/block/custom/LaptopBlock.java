...
public class LaptopBlock extends HorizontalFacingBlock {
    ...
    private static final VoxelShape VOXEL_SHAPE = VoxelShapes.cuboid(0.5 - 7 / 16.0, 0.0, 0.5 - 7 / 16.0, 0.5 + 7 / 16.0, 4.0 / 16.0, 0.5 + 7 / 16.0);
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.translatable("tooltip.seasonal_adventures.under_development.detailed").formatted(Formatting.RED));
        }
    }
