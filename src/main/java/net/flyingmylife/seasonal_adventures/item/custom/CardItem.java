...
public class CardItem extends Item {
    public static final ComponentType<String> CARD_ID_COMPONENT_TYPE = Registry.register(
            Registries.DATA_COMPONENT_TYPE,
            Identifier.of(SA.MOD_ID, "card_id"),
    ...
    public static ItemStack createCardItem(String cardId) {
        ...
        cardItem.set(CARD_ID_COMPONENT_TYPE, cardId);
        return cardItem;
    }

    @Override
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        String cardId = stack.get(CARD_ID_COMPONENT_TYPE);
        if (cardId != null) {
