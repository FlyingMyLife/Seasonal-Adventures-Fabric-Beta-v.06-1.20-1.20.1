package net.flyingmylife.seasonal_adventures.entity;
...
import net.flyingmylife.seasonal_adventures.entity.client.render.ATMRenderer;
...
import static net.flyingmylife.seasonal_adventures.SA.MOD_ID;
