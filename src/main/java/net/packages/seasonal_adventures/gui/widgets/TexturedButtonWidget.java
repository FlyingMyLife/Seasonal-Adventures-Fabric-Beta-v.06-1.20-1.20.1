...
public class TexturedButtonWidget extends net.minecraft.client.gui.widget.TexturedButtonWidget {
    ...
    public TexturedButtonWidget(int x, int y, int width, int height, int u, int v, int hoverV, Identifier texture, Identifier disabledTexture, int textureWidth, int textureHeight, PressAction onPress, Text message) {
