...
public class CardItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        String cardId = nbt.getString("CardID");
        Text grayText = Text.translatable("tooltip.flying_machines.cardId").setStyle(Style.EMPTY.withColor(Formatting.GRAY));
        ...
        tooltip.add(Text.translatable("tooltip.flying_machines.cardtooltip.upper").setStyle(Style.EMPTY.withColor(Formatting.GRAY).withItalic(true)));
        tooltip.add(Text.translatable("tooltip.flying_machines.cardtooltip").setStyle(Style.EMPTY.withColor(Formatting.GRAY).withItalic(true)));
    }
}
