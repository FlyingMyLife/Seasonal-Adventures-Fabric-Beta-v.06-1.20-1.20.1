...
public enum ArmorMaterials implements ArmorMaterial {
    ActiveBiologicalProtectionSuit("abp_suit", 26, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 2);
        map.put(ArmorItem.Type.LEGGINGS, 5);
        map.put(ArmorItem.Type.CHESTPLATE, 7);
        map.put(ArmorItem.Type.HELMET, 2);
    }), 8, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2.2F, 0.7F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.TITANIUM_SHEET});
    });
