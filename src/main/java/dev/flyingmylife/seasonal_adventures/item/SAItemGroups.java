package dev.flyingmylife.seasonal_adventures.item;
...
public class SAItemGroups {
    public static final ItemGroup THE_LAST_REALITY = Registry.register(Registries.ITEM_GROUP,
            Identifier.of(SA.MOD_ID, "the_last_reality"),
            FabricItemGroup.builder().displayName(Text.translatable("item_group.seasonal_adventures.the_last_reality"))
                    .icon(() -> new ItemStack(SAItems.SYS_CABLE)).entries((displayContext, entries) -> {
                        ...
                        entries.add(SAItems.REFINED_TITANIUM_INGOT);
                        entries.add(SAItems.REFINED_TITANIUM_SHEET);
                        entries.add(SABlocks.REFINED_TITANIUM_BLOCK);
    ...
    public static final ItemGroup THE_HEART_OF_UNIVERSE = Registry.register(Registries.ITEM_GROUP,
            Identifier.of(SA.MOD_ID, "the_heart_of_universe"),
    ...
    public static void registerItemGroups() {
        SA.LOGGER.info("Registering Item groups for " + SA.MOD_ID);
    }
}
