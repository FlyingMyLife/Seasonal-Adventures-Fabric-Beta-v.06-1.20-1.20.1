package dev.flyingmylife.seasonal_adventures.api.jade.provider.block;
...
public enum LockedChestComponentProvider implements
    ...
    INSTANCE;
    private static final Block [] levels = {SABlocks.LOCKED_CHEST_LVL_COPPER, SABlocks.LOCKED_CHEST_LVL_IRON,
            SABlocks.LOCKED_CHEST_LVL_GOLD, SABlocks.LOCKED_CHEST_LVL_DIAMOND, SABlocks.LOCKED_CHEST_LVL_NETHERITE};
    ...
    public Identifier getUid() {
        return Identifier.of(SA.MOD_ID, "locked_chest_component_provider");
    }
